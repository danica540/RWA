...
import { ADD_BOOKS, AddBooks, FETCH_BOOKS } from "./actions";
import { Book } from "../models/Book";
import { getAllBooks } from "../services/book.service";

const initialState: any = getAllBooks();
export function reducer(state: Book[] = initialState, action: Action) { //ako state nije naveden da bude inicijalno!
    switch (action.type) {
        case ADD_BOOKS: {
